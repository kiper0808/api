...
type FileStorage struct {
	Secret string `env:"FILE_STORAGE_SECRET" env-required:"true" env-description:"secret key"`
}
...
type Database struct {
	...
	DBName             string        `env:"MYSQL_DBNAME" env-required:"true" env-description:"database name, e.g. karma8"`
	User               string        `env:"MYSQL_USER" env-default:"root" env-description:"database username, e.g. karma8"`
